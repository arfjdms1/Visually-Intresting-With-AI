...
VOTE_DB_PATH = Path("/tmp/votes.json")  # New file to track votes by IP

pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")
ADMIN_USERNAME = "admin"
# This hash corresponds to the password "21@Pril2012"
...
# --- Security & Database Utility Functions ---
...
async def get_leaderboard():
    ...
    sorted_models = sorted(all_models, key=lambda x: (-x["votes"], x["name"]))
